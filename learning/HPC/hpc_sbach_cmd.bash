...
#SBATCH -J RevNewRew			    # name of job
...
#SBATCH -o ../outs/RevNewRew_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/RevNewRew_%A_%a.err		# name of error file for this submission script
