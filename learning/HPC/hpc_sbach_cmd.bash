#!/bin/bash
#SBATCH --array=1-1             # set up the array
#SBATCH -J BroNetFixed			    # name of job
...
#SBATCH -o ../outs/BroNetFixed_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/BroNetFixed_%A_%a.err		# name of error file for this submission script
