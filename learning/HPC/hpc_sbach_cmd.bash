...
#SBATCH -o ../outs/WD0-01_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/WD0-01_%A_%a.err		# name of error file for this submission script
