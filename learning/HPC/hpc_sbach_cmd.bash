...
#SBATCH -J OldParams			    # name of job
...
#SBATCH -o ../outs/OldParams_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/OldParams_%A_%a.err		# name of error file for this submission script
