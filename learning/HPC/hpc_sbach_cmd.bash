#!/bin/bash
#SBATCH --array=2-2             # set up the array
#SBATCH -J InitBetter2			    # name of job
...
#SBATCH -o ../outs/InitBetter2_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/InitBetter2_%A_%a.err		# name of error file for this submission script
