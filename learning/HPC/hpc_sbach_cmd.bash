...
#SBATCH -J RevOldRew			    # name of job
...
#SBATCH -o ../outs/RevOldRew_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/RevOldRew_%A_%a.err		# name of error file for this submission script
