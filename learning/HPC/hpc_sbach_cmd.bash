...
#SBATCH -J lock_FPiH			    # name of job
...
#SBATCH -o ../outs/lock_FPiH_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/lock_FPiH_%A_%a.err		# name of error file for this submission script
