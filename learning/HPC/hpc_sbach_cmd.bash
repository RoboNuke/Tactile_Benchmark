...
#SBATCH -J simTestR2			    # name of job
...
#SBATCH -o ../outs/simTestR2_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/simTestR2_%A_%a.err		# name of error file for this submission script
