...
#SBATCH -J InitBetter			    # name of job
...
#SBATCH -o ../outs/InitBetter_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/InitBetter_%A_%a.err		# name of error file for this submission script
