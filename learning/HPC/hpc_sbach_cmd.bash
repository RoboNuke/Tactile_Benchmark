...
#SBATCH -o ../outs/EntMin_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/EntMin_%A_%a.err		# name of error file for this submission script
