...
#SBATCH -J ldis_FPiH			    # name of job
...
#SBATCH -o ../outs/ldis_FPiH_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/ldis_FPiH_%A_%a.err		# name of error file for this submission script
