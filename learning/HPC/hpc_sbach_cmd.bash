...
#SBATCH -o ../outs/Ent_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/Ent_%A_%a.err		# name of error file for this submission script
