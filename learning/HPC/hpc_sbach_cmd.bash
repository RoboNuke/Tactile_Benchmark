...
#SBATCH -J SFPiH_neg			    # name of job
...
#SBATCH -o ../outs/SFPiH_neg_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/SFPiH_neg_%A_%a.err		# name of error file for this submission script
