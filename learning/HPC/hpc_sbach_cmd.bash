...
#SBATCH -J OldShampoo			    # name of job
...
#SBATCH -o ../outs/OldShampoo_%A_%a.out		# name of output file for this submission script
#SBATCH -e ../outs/OldShampoo_%A_%a.err		# name of error file for this submission script
